(function() {
    ...
    muktiMovementApp.config(function($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider) {
        ...
        $stateProvider
            ...
            .state('astangayoga', {
                url: '/astangayoga',
                templateUrl: 'partials/movement/yoga/astanga.html'
            })
            .state('vinyasayoga', {
                url: '/vinyasayoga',
                templateUrl: 'partials/movement/yoga/vinyasa.html'
            })
            .state('bagua', {
                url: '/bagua',
                templateUrl: 'partials/movement/martial/bagua.html',
                controller: 'baguaCtrl'
            })
            .state('xingyi', {
                url: '/xingyi',
                templateUrl: 'partials/movement/martial/xingyi.html',
                controller: 'xingYiCtrl'
            })
            .state('taiji', {
                url: '/taiji',
                templateUrl: 'partials/movement/martial/taiji.html'
            })
            .state('muaythai', {
                url: '/muaythai',
    ...
    muktiMovementApp.service('MuayBoranDataService', function() {
    ...
    muktiMovementApp.service('MuayBoranService', function(MuayBoranDataService) {
    ...
    muktiMovementApp.controller('muayThaiCtrl', ['$scope', 'MuayBoranService', function($scope, MuayBoranService) {
    ...
    muktiMovementApp.service('XingYiDataService', function() {
    ...
    muktiMovementApp.service('XingYiService', function(XingYiDataService) {
        this.getAllTechniques = function() {
    ...
    muktiMovementApp.service('BaguaService', function(BaGuaDataService) {
